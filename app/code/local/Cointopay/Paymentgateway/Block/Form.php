...
class Cointopay_Paymentgateway_Block_Form extends Mage_Payment_Block_Form {
    ...
    **/
	...
	{
	    parent::_construct();
	    $this->setTemplate('cointopaygateway/form.phtml');
	}
	...
	public function getInfoData($text = NULL) {
